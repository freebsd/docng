...
mailto:yourlogin@example.FreeBSD.org[yourlogin@example.FreeBSD.org] zu senden, vorausgesetzt dass Sendmail auf `example.FreeBSD.org` korrekt läuft.
...
Um E-Mails von 
mailto:user@example.com[user@example.com] an die externe Adresse 
mailto:goodmail@example2.com[goodmail@example2.com] weiterzuleiten:
...
Um E-Mails, die kürzer als 1000 Bytes sind, an 
mailto:goodmail@example2.com[goodmail@example2.com] weiterzuleiten:
...
Um E-Mails, die an 
mailto:alternate@example.com[alternate@example.com] geschickt werden, im Postfach [.filename]#alternate# zu speichern:

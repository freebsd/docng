...
Wenn Sie Sich nicht sicher sind, auf welcher Liste Sie Ihre Frage stellen sollen, sollten Sie den Artikel link:{freebsd-questions}[ How to get best results from the FreeBSD-questions mailing list] lesen.
...
Um eine Nachricht an eine Mailingliste zu schicken, schreiben Sie einfach eine E-Mail an 
mailto:Liste@FreeBSD.org[Liste@FreeBSD.org]. Die E-Mail wird dann an alle Mitglieder der Mailingliste verteilt.

Wenn Sie das Abonnement aufheben wollen, folgen Sie der URL, die am Ende jeder Mail der Liste angegeben ist. Sie können das Abonnement auch mit einer E-Mail an 
mailto:Liste-unsubscribe@FreeBSD.org[Liste-unsubscribe@FreeBSD.org] aufheben.

...
Dieser Abschnitt beschreibt wie die Linux(R)-Binärkompatibilität funktioniert. Die folgenden Informationen stammen aus einer E-Mail, die von Terry Lambert (
mailto:tlambert@primenet.com[tlambert@primenet.com]) an {freebsd-chat} geschrieben wurde (Message ID: `<199906020108.SAA07001@usr09.primenet.com>`).

...
`{grog}`::
Original author of most of the material on mailing list etiquette, taken from the article on link:{freebsd-questions}[How to get best results from the FreeBSD-questions mailing list].

...
Autor original da maior parte do material sobre etiqueta nas listas de discussão, retirada do artigo sobre link:{freebsd-questions}[Como para obter os melhores resultados da lista de discussão FreeBSD-questions].

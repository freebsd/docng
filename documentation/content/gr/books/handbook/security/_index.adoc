...
[.note]
====
[.admontitle]*Command vs. Protocol:* +
...
Since this is an extension to the configuration of `inetd`, the reader is expected have read the <<network-inetd,inetd configuration>> section.

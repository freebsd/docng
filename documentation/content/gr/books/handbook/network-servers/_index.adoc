...
Για περισσότερες λεπτομέρειες δείτε το `PACKET FILTERING` στην ενότητα man:ppp[8] και τα παραδείγματα στο [.filename]#/usr/share/examples/ppp/#.
...
Η τεκμηρίωση για τους εξυπηρετητές NTP διατίθεται και σε φόρμα HTML στο [.filename]#/usr/share/doc/ntp/#.

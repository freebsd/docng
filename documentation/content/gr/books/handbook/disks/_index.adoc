...
* Να ξέρετε πως να <<kernelconfig,ρυθμίσετε και να εγκαταστήσετε ένα νέο πυρήνα του FreeBSD>>.
...
Beside the <<disks-adding,Adding Disks>> and <<mount-unmount,Mounting and Unmounting File Systems>> sections, reading various manual pages may also be useful: man:umass[4], man:camcontrol[8], and man:usbconfig[8] under FreeBSD 8.X or man:usbdevs[8] under earlier versions of FreeBSD.
...
Sometimes, a SCSI CD-ROM may be missed because it did not have enough time to answer the bus reset. To resolve this, add the following option to the kernel configuration and <<kernelconfig-building,rebuild the kernel>>.
...
Livefs CD images are not available for FreeBSD {u-rel120};-RELEASE and later. In addition to the CD-ROM installation images, flash drive installation images may be used to recover a system. The "memstick" image for FreeBSD/i386 {u-rel120};-RELEASE is available from link:ftp://ftp.FreeBSD.org/pub/FreeBSD/releases/i386/i386/ISO-IMAGES/{u-rel120};/FreeBSD-{u-rel120};-RELEASE-i386-memstick.img[ftp://ftp.FreeBSD.org/pub/FreeBSD/releases/i386/i386/ISO-IMAGES/{u-rel120};/FreeBSD-{u-rel120};-RELEASE-i386-memstick.img].
====
...
These include network file systems such as the <<network-nfs,Network File System>> and Coda, memory-based file systems, and file-backed file systems.
...
FreeBSD offers a feature in conjunction with <<soft-updates,Soft Updates>>: file system snapshots.
...
FreeBSD offers excellent online protections against unauthorized data access. File permissions and <<mac,Mandatory Access Control>> (MAC) help prevent unauthorized users from accessing data while the operating system is active and the computer is powered up. However, the permissions enforced by the operating system are irrelevant if an attacker has physical access to a computer and can move the computer's hard drive to another system to copy and analyze the data.
...
More information about configuring [.filename]#rc.d# is provided in the <<configtuning-rcd,rc.d>> section of the Handbook.
...
The man:gbde[8] or man:geli[8] encryption systems may be used for swap encryption. Both systems use the [.filename]#encswap#<<configtuning-rcd,rc.d>> script.
...
* Have a good understanding of <<network-communication,FreeBSD networking>>.

...
MIPS is a link:{committers-guide}#archs[Tier 3] architecture, and as such is currently regarded as experimental. It is not supported by the FreeBSD project.

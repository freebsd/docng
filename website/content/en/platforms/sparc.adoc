...
UltraSPARC is a link:{committers-guide}#archs[Tier 2] architecture, and as such is not fully supported by the FreeBSD project. Although fully functional, the port is not as feature-complete as the i386 or amd64 ports.
